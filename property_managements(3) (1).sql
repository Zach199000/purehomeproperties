...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 18, 2024 at 02:46 PM
...
INSERT INTO `payments` (`id`, `user_id`, `property_id`, `amount`, `total_amount`, `status`, `created_at`, `due_date`, `payment_method`, `check_image`, `payment_date`) VALUES
(1, 1, 1, 1500.00, 50000.00, 'completed', '2024-10-09 00:37:45', '2024-11-18', NULL, NULL, NULL),
(4, 2, 1, 1500.00, 50000.00, 'pending', '2024-10-13 09:52:16', '2024-11-18', 'bank transfer', NULL, NULL),
(5, 2, 2, 800.00, 50000.00, 'completed', '2024-10-13 09:52:16', '2024-11-18', 'cash', NULL, NULL),
(6, 1, 1, 1500.00, 50000.00, 'completed', '2024-10-15 12:45:29', '2024-11-18', 'check', NULL, NULL),
(7, 1, 1, 1500.00, 50000.00, 'completed', '2024-10-15 12:49:18', '2024-11-18', 'check', NULL, NULL),
(8, 1, 1, 5000.00, 50000.00, 'completed', '2024-10-15 15:00:56', '2024-11-18', 'check', 'uploads/Untitled.jpg', NULL),
(9, 1, 1, 5000.00, 50000.00, 'completed', '2024-10-16 09:15:13', '2024-11-18', 'check', 'uploads/Untitled.jpg', NULL),
(11, 1, 1, 1500.00, 50000.00, 'completed', '2024-10-17 12:36:49', '2024-11-18', 'credit_card', NULL, NULL),
(12, 3, 10, 20000.00, 0.00, 'completed', '2024-10-18 15:39:25', '2024-11-29', 'cash', NULL, NULL),
(14, 3, 2, 20000.00, 50000.00, 'completed', '2024-10-18 16:26:10', NULL, NULL, NULL, NULL),
(15, 3, 2, 20000.00, 50000.00, 'completed', '2024-10-18 16:26:59', NULL, NULL, NULL, NULL);
...
INSERT INTO `tenants` (`id`, `name`, `email`, `phone`, `property_id`, `status`, `payment_due`, `contract_expiry`, `password`, `profile_picture`) VALUES
(1, 'Joe Anderson', 'joe.anderson@example.com', '555-1234', 1, 'occupied', '2024-10-15', '2024-12-31', '$2y$10$EZE5OVcX8oMWG8yzk6H4quUXow9n37aFn95Tj78VPMSIyzcmr5YN.', NULL),
(2, 'Mike Johnson', 'mike.johnson@example.com', '555-5678', 2, 'vacant', NULL, NULL, '$2y$10$T/szKS1RsINHZ3JKJZpNvOiFXuw77OscgckFO1m1Dpr5EEJXFFPT6', NULL),
(3, 'Sarah Hudaifa', 'sarah.hudaifa@example.com', '555-9101', 2, 'occupied', '2024-07-03', '2025-07-02', '$2y$10$oD0ohVYmwmJ7yO3hxQR0Q.tNPRzlRjy7CWvqGXVpG0u.sCHNgdihq', NULL),
(4, 'Lucy Marfa', 'lucy.marfa@example.com', '555-1122', NULL, 'occupied', '2024-09-30', '2024-10-15', '$2y$10$F9I3/7G0a.tuOFx2Xy8UpeRglJVPfif3eAufBE24ytGE4gEYOEyJW', NULL),
(5, 'Emma Sunset', 'emma.sunset@example.com', '555-3344', NULL, 'vacant', NULL, NULL, NULL, NULL),
(6, 'David Greenfield', 'david.greenfield@example.com', '555-5566', NULL, 'occupied', '2024-10-20', '2024-12-15', '$2y$10$C.jbOxBrXVoda0LK.PMVeOUHbviYVp8dwVcuAlwCbH3ZGuDvMDePK', NULL);
...
INSERT INTO `users` (`id`, `username`, `password`, `role`, `email`, `phone_number`, `created_at`) VALUES
